...
sap.ui.define([
	...
	function (
		 ...
		 */
		var Page = Control.extend("ey.cc.eydcc.controls.EYPage", /** @lends sap.m.Page.prototype */ {
			metadata: {
				...
				aggregations: {
					...
					headerContent: {
						...
						forwarding: {
							getter: "_getInternalHeader",
							aggregation: "contentRight"
						}
					},
		...
		Page.prototype.setShowFooter = function (bShowFooter) {
			...
			var tesy=(bShowFooter) ? this.$().addClass("sapMPageWithFooter") : this.$().removeClass("sapMPageWithFooter");

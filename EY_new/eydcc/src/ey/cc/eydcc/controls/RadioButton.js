...
sap.ui.define(['jquery.sap.global', './../library', 'sap/ui/core/Control', 'sap/ui/core/EnabledPropagator',
		...
		'sap/m/Label', 'sap/ui/core/library',
	...
	var TextDirection = coreLibrary.TextDirection;
		 ...
		 * @constructor
		 * @public
		 * @alias ey.cc.eydcc.controls.RadioButton
		 * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel
		 */
 var RadioButton = Control.extend("ey.cc.eydcc.controls.RadioButton", /** @lends sap.m.RadioButton.prototype */ { metadata : {
	...
	RadioButton.prototype.ontap = function(oEvent) {
		...
		var eyMarked=oEvent && oEvent.setMarked();
	...
	*/
	...
	RadioButton.prototype.setSelected = function(bSelected) {
		...
		if ((bSelectedOld !== !!bSelected) && this.getDomRef()) {
			this.$().toggleClass("eyDRbSel", bSelected);
	...
	RadioButton.prototype.setText = function(sText) {
		...
		this.toggleStyleClass("eyDRbHasLabel", !!sText);
	...
	RadioButton.prototype._createLabel = function(prop, value) {
		this._oLabel = new Label(this.getId() + "-label").addStyleClass("eyDRbBLabel").setParent(this, null, true);

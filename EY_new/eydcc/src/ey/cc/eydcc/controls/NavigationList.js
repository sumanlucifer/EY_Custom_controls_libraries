...
sap.ui.define(['jquery.sap.global', './../library', 'sap/ui/core/Control','sap/ui/core/Element','sap/m/Popover',
	'sap/ui/core/delegate/ItemNavigation',
	'sap/ui/core/InvisibleText',
	"./NavigationListRenderer",
	"sap/base/Log"],
	function (jQuery, library, Control,Element,Popover,
		ItemNavigation,
		InvisibleText,
		NavigationListRenderer,
		Log) {
		...
		/**
		 * Constructor for a new NavigationList Control.
		 *
		 ...
		 * @constructor
		 * @public
		 * @alias ey.cc.eydcc.controls.NavigationList
		 * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel
		 */
		var NavigationList = Control.extend("ey.cc.eydcc.controls.NavigationList", {
		metadata: {
				library: "ey.cc.eydcc",
				properties: {
					/**
				...
				aggregations: {
					 ...
					 */
					items: {type: "ey.cc.eydcc.controls.NavigationListItem", multiple: true, singularName: "item"}
				},
				associations: {
					/**
					 ...
					 * @since 1.52.0
					 */
					selectedItem: {type: "ey.cc.eydcc.controls.NavigationListItem", multiple: false}
				},
				events: {
					/**
	...
	NavigationList.prototype.init = function () {
		 ...
		 * @public
		 * @return {ey.cc.eydcc.controls.NavigationListItem|null} The selected item or null if nothing is selected
		 */
		 ...
		 * @public
		 * @param {string|ey.cc.eydcc.controls.NavigationListItem} selectedItem The control to be set as selected
		...
		NavigationList.prototype.setSelectedItem = function (selectedItem) {
			...
			isNavigationListItem = selectedItem instanceof Element && selectedItem.isA("ey.cc.eydcc.controls.NavigationListItem");

			if (typeof selectedItem !== 'string' && !isNavigationListItem) {
				Log.warning('Type of selectedItem association should be string or instance of ey.cc.eydcc.controls.NavigationListItem. New value was not set.');
